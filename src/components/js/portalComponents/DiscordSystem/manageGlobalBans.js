...
import '../../../css/portalComponents/DiscordSystem/GlobalBans.css';

import Button from '../../Button';
import TextBox from '../../TextBox';
import Loader from '../../Loader';
import ManageGlobalBansRow from './manageGlobalBansRow';
import CreateGlobalBanPopup from '../../popups/CreateGlobalBan';

import AuthContext from '../../modules/AuthContext';
import * as DiscordModeration from '../../modules/DiscordModerations';

function ManageGlobalBans() {
    ...
    const applyFilter = () => {
        const bansFilter = ban => ban.discordID.toString().includes(filter) || (ban.moderator && ban.moderator.toString().includes(filter)) || (ban.robloxID && ban.robloxID.toString().includes(filter)) || (ban.reason && ban.reason.toLowerCase().includes(filter.toLowerCase()));
    ...
    return (
        <>
            <div className='manage-roblox-bans-page'>
                ...
                {popupState == 'opened' && 
                    <CreateGlobalBanPopup setState={setPopupState}/>
                }
                    ...
                    <>
                        <div style={{'borderBottom': '1px solid #706f6f', 'borderBottomLeftRadius': '5px', 'borderBottomRightRadius': '5px'}} className='manage-roblox-bans-container'>
                            <div className='manage-roblox-bans-container-header-row'>
                                <h1><i style={{'marginRight': '4px'}} class='fa-solid fa-circle-info'/> Global Ban Actions</h1>
                            </div>
                            ...
                            <div className='manage-roblox-bans-table'>
                                <div style={{'alignItems': 'center', 'justifyContent': 'center'}} className='manage-roblox-bans-container-row'>
                                    {authContext.user.permissions.Flags.CREATE_GLOBAL_BANS &&
                        ...
                        <div className='manage-roblox-bans-container'>
                            <div className='manage-roblox-bans-container-header-row'>
                                <h1><i style={{'marginRight': '4px'}} class='fa-solid fa-gavel'/> Global Bans</h1>
                            </div>
                            ...
                            <div className='manage-roblox-bans-table manage-roblox-bans-table-container'>
                                {pagination.currentData && pagination.currentData.map((listedBan, i) => {
                                    return <ManageGlobalBansRow ban={listedBan}/>;
                                })}
                            </div>
...
export default ManageGlobalBans;